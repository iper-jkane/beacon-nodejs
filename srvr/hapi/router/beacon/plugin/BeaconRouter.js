...
const BeaconRouter = {
  ...
  register: async function (server, options) {
    ...
    const authDb = {
      users: [ { uid: 1000, given_name: "Biolo", family_name: "Gist", email: "null@dev.null", email_verified: true, user: "bgist", pass: " $2b$12$O9oo7dWbDgAPikRY8gAogeh7TRJ9ZctihsckEBKwVUexoGfjsAW1K" } ]
    };
